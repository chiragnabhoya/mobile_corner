...
<html lang="en">
    ...
    <head>
        <title>Contact Us - Mobile Corner</title>
            ...
            <div class="custom-container">
                <div class="row section-big-pb-space">
                    <div class="col-xl-6 offset-xl-3">
                        ...
                        <form class="theme-form" action="" method="POST" name="contactus">
                            <div class="form-row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  name="mo" type="text" class="form-control" id="review" placeholder="Enter your number" value="<?php
                                            if (!isset($success) && set_value('mo')) {
                                                echo set_value('mo');
                                            }
                                            ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input  name="subject" type="text" class="form-control" id="email" placeholder="subject" value="<?php
                                ...
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <textarea  name="message" class="form-control" placeholder="Write Your Message" id="exampleFormControlTextarea1" rows="2" style="resize: none"><?php
                                ...
                                <div class="col-md-12">
                                    <div col-md-12>
                                    <button value="ADD" name="add" class="btn btn-normal" type="submit">Send Your Message</button>
                                    <?php
                                                if (isset($success)) {
                                                    ?>
                                                    <br/><br/>
                ...
                <div class="row">
                    <div class="col-lg-12 map">
                        <div class="theme-card">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3720.4206304937547!2d72.8004021134254!3d21.175443088133854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04dfa3d14ec83%3A0x537073b479571bce!2sM.L.PARMAR%20COLLEGE%20OF%20COMPUTER%20SCIENCE%20AND%20IT!5e0!3m2!1sen!2sin!4v1614527812432!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
