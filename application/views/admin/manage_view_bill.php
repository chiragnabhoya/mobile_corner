    ...
    <body>
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <select name="billno" onchange="admin_viewbill('billno',this.value);" class="form-control input-sm mb-md" >
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <input type="date" onchange="admin_viewbill('date',this.value);"  class="form-control input-sm mb-md" >
                                                
                                        </div>  
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <select onchange="admin_viewbill('productname',this.value);" class="form-control input-sm mb-md" >
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <select onchange="admin_viewbill('member',this.value);" class="form-control input-sm mb-md" >
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <select onchange="admin_viewbill('pay_type',this.value);" class="form-control input-sm mb-md" >
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">                                           
                                            <select onchange="admin_viewbill('promocode',this.value);" class="form-control input-sm mb-md" >
        ...
        <script type="text/javascript">
            function admin_viewbill(action , id)
            {
                ...
                var path = 'http://localhost/mobile_corner/Backend/admin_viewbill/';
