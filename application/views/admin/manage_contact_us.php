                ...
                <section role="main" class="content-body">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">View All Contacts</h2>
                        </header>
                                ...
                                <div class="container">
                                    ...
                                    <div  class="row">
                                        <tr >
                                            ...
                                            <th style="vertical-align:middle; text-align: center;" class="hidden-xs">Subject</th>
                                ...
                                <tbody>
                                    ...
                                    <div  class="row">
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle; text-align: center;" class="center hidden-xs"><?php echo $data->mobile;?></td>
                                            <td style="vertical-align:middle; text-align: center;" class="center hidden-xs"><?php echo $data->subject;?></td>
                                            <td style="vertical-align:middle; text-align: center;" class="center hidden-xs"><?php echo $data->message;?></td>
                                            <td data-toggle="modal" data-target="#myModal" style="vertical-align:middle; text-align: center;" >
                                                <a onclick="$('#delete-link').attr('href','<?php echo base_url();?>delete/contact/<?php echo $data->contact_id; ?>')">
