                ...
                <section role="main" class="content-body">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">View My Review</h2>
                        </header>
                                    ...
                                    <div  class="row">
                                        <tr>
                                            ...
                                            <td data-toggle="modal" data-target="#myModal" style="vertical-align:middle; text-align: center;" class="center hidden-xs">
                                                <a onclick="$('#delete-link').attr('href','<?php echo base_url(); ?>delete/memberreview/<?php echo $data->review_id; ?>')" data-toggle="tooltip" title="Remove Data" class="fa fa-trash" style="color: red;"></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
